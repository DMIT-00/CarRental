...
<form:form method="POST" action="${pageContext.request.contextPath}/car-edit/${car.id}" modelAttribute="car">
    ...
    <div class="container mt-4 col-md-12">
        <div class="row">
            <div class="col text-center">
                <button type="submit" style="width:100%;" name="submit-car" class="btn btn-primary btn-lg btn-block"><fmt:message key="button.edit"/></button>
            </div>
        </div>
    </div>
</form:form>
