        ...
        <div class="row">
            <div class="col-sm">
                <input type="text" id="username" name="username" class="form-control"
                       placeholder="<fmt:message key="user.username"/>" required
                       autofocus>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-4 col-md-2">
        <div class="row">
            <div class="col text-center">
                <button style="width:100%;" class="btn btn-primary btn-lg btn-block"
                        type="submit"><fmt:message key="navbar.login"/></button>
            </div>
        </div>
    </div>
